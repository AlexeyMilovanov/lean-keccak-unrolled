...
def generateCircuitFile : IO Unit := do
  ...
  IO.FS.writeFile "KeccakEngine/CircuitData.lean" out
  IO.println "CircuitData.lean successfully generated!"

end KeccakEngine

-- ⚠️ Uncomment the line below ONCE to generate the CircuitData.lean file, then comment it out again.
 #eval KeccakEngine.generateCircuitFile
